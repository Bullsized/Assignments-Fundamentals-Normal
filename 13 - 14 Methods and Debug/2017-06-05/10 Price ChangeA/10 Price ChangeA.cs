    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < numberOfPrices - 1; i++)
            {
                ...
                double contrast = Percentage(lastPrice, currentPrice); bool isSignificantDifference = Contrast(contrast, threshold);
        ...
        public static string Get(double currentPrice, double lastPrice, double contrast, bool etherTrueOrFalse)
        {
            ...
            else if (etherTrueOrFalse && (contrast > 0))
            {
